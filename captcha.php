...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (!empty($response['success']) and $response['success'] == 'true') {
        ...
        if (!empty($_GET['url'])) {
            header("Location: " . base64_decode(filter_input(INPUT_GET, 'url')), true, 301);
        } else {
...
<html>
    ...
    <body>
        ...
        <form action="captcha.php?url=<?php echo filter_input(INPUT_GET, 'url'); ?>" method="post">
            <div class="g-recaptcha" data-sitekey="6LfAqQoUAAAAAJClb7DM8o6C2jTfvr8k9cpDxn4H"></div>
            <br />
